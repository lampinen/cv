...
James L. McClelland, Bruce L. McNaughton, and \textbf{Andrew K. Lampinen} (in press), {``Integration of new information in memory: new insights from a complementary learning sytems perspective''}, \textit{Proceedings of the Royal Society B} \\[3pt]
...
Felix Hill, \textbf{Andrew K. Lampinen}, Rosalia Schneider, Stephen Clark, Matthew Botvinick, James L. McClelland, and Adam Santoro (2020), {``Emergent systematic generalization in a situated agent,''} \textit{Proceedings of the 8th International Conference on Learning Representations} \\ [3pt] 
