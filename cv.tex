...
\textbf{Andrew K. Lampinen}, Stephanie C.Y. Chan, Yuxuan Li, and Katherine Hermann (2026), {``Representation Biases: will we achieve complete understanding by analyzing representations?''}, \textit{eNeuro Theory/New Concepts}\\[3pt]
Lukas Muttenthaler, Klaus Greff, Frieda Born, Bernhard Spitzer, Simon Kornblith, Michael C. Mozer, Klaus-Robert M{\"u}ller, Thomas Unterthiner, \textbf{Andrew K. Lampinen}, (2025), {``Aligning machine and human visual representations across abstraction levels'',} \textit{Nature}\\[3pt]
Andrea Gregor de Varda, Ferdinando Pio D'Elia, Hope Kean, \textbf{Andrew K. Lampinen}, and Evelina Fedorenko (2025), {``The cost of thinking is similar between large reasoning models and humans''}, \textit{Proceedings of the National Academy of Sciences}\\[3pt]
Ilia Sucholutsky, Lukas Muttenthaler, Adrian Weller, Andi Peng, Andreea Bobu, Been Kim, Bradley C Love, Erin Grant, Jascha Achterberg, Joshua B Tenenbaum, Katherine M Collins, Katherine L Hermann, Kerem Oktar, Klaus Greff, Martin N Hebart, Nori Jacoby, Raja Marjieh, Robert Geirhos, Sherol Chen, Simon Kornblith, Sunayana Rane, Talia Konkle, Thomas P O'Connell, Thomas Unterthiner, \textbf{Andrew K. Lampinen*}, Klaus-Robert M{\"u}ller*, Mariya Toneva*, Thomas L Griffiths* (2025), {``Getting aligned on representational alignment'',} \textit{Transactions on Machine Learning Research}, (*equal advising/senior authors) \\[3pt]
...
{``How Language Models Reason About Information From Parameters and Context'',} \textit{Cognitive Basis of Reasoning (in Minds and AI), IVADO}, November 2025\\[3pt] 
